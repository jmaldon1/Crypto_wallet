...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../qsys/crypto_wallet.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001850
SOPC_SYSID_FLAG += --sidp=0x4001850
ELF_PATCH_FLAG  += --sidp 0x4001850

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1543192236
SOPC_SYSID_FLAG += --timestamp=1543192236
ELF_PATCH_FLAG  += --timestamp 1543192236
