...
# ----------------------------------------
# ACDS 18.1 625 win32 2018.11.26.20:41:28
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "crypto_wallet"
}
...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_b.hex ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/crypto_wallet_epcs_flash_controller_boot_rom.hex ./
}
...
ensure_lib                                                      ./libraries/buttons_pi_avalon_parallel_port_slave_agent_rsp_fifo/
vmap       buttons_pi_avalon_parallel_port_slave_agent_rsp_fifo ./libraries/buttons_pi_avalon_parallel_port_slave_agent_rsp_fifo/
ensure_lib                                                      ./libraries/buttons_pi_avalon_parallel_port_slave_agent/         
vmap       buttons_pi_avalon_parallel_port_slave_agent          ./libraries/buttons_pi_avalon_parallel_port_slave_agent/         
ensure_lib                                                      ./libraries/cpu_data_master_agent/                               
vmap       cpu_data_master_agent                                ./libraries/cpu_data_master_agent/                               
ensure_lib                                                      ./libraries/buttons_pi_avalon_parallel_port_slave_translator/    
vmap       buttons_pi_avalon_parallel_port_slave_translator     ./libraries/buttons_pi_avalon_parallel_port_slave_translator/    
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_avalon_st_adapter_006_error_adapter_0.sv" -work error_adapter_0                                     
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"     -work error_adapter_0                                     
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_avalon_st_adapter_006.vhd"                -work avalon_st_adapter_006                               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_avalon_st_adapter.vhd"                    -work avalon_st_adapter                                   
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                                         
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_rsp_mux.sv"                               -work rsp_mux                                             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_rsp_demux.sv"                             -work rsp_demux                                           
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_cmd_mux_004.sv"                           -work cmd_mux_004                                         
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_cmd_mux.sv"                               -work cmd_mux                                             
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                                       
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_cmd_demux.sv"                             -work cmd_demux                                           
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_router_008.sv"                            -work router_008                                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_router_006.sv"                            -work router_006                                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_router_002.sv"                            -work router_002                                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_router_001.sv"                            -work router_001                                          
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0_router.sv"                                -work router                                              
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                  -work buttons_pi_avalon_parallel_port_slave_agent_rsp_fifo
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -work buttons_pi_avalon_parallel_port_slave_agent         
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work buttons_pi_avalon_parallel_port_slave_agent         
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                        -work buttons_pi_avalon_parallel_port_slave_translator    
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu.v"                                                  -work cpu                                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_debug_slave_sysclk.v"                               -work cpu                                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_debug_slave_tck.v"                                  -work cpu                                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_debug_slave_wrapper.v"                              -work cpu                                                 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu_cpu_test_bench.v"                                       -work cpu                                                 
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/crypto_wallet_irq_mapper.sv"                                              -work irq_mapper                                          
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_mm_interconnect_0.v"                                        -work mm_interconnect_0                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/submodules/crypto_wallet_uart_0.vhd"                                                 -work uart_0                                              
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/crypto_wallet_cpu.v"                                                      -work cpu                                                 
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/crypto_wallet.vhd"                                                                                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L avalon_st_adapter_006 -L avalon_st_adapter -L sdram_s1_rsp_width_adapter -L rsp_mux_001 -L rsp_mux -L rsp_demux -L cmd_mux_004 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L sdram_s1_burst_adapter -L router_008 -L router_006 -L router_002 -L router_001 -L router -L buttons_pi_avalon_parallel_port_slave_agent_rsp_fifo -L buttons_pi_avalon_parallel_port_slave_agent -L cpu_data_master_agent -L buttons_pi_avalon_parallel_port_slave_translator -L cpu_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_0 -L uart_0 -L sysid -L sdram -L epcs_flash_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
