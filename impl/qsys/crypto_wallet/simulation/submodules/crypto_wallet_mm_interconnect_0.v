...
module crypto_wallet_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> epcs_flash_controller_epcs_control_port_agent:cp_channel
	...
	wire  [103:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> po_led_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                     // po_led_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> po_led_s1_agent:cp_channel
	...
	wire  [104:0] pi_key_s1_agent_rf_source_data;                                            // pi_key_s1_agent:rf_source_data -> pi_key_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pi_key_s1_agent_rsp_fifo_out_data;                                         // pi_key_s1_agent_rsp_fifo:out_data -> pi_key_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> pi_key_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // pi_key_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> pi_key_s1_agent:cp_channel
	...
	wire  [104:0] pi_sw_s1_agent_rf_source_data;                                             // pi_sw_s1_agent:rf_source_data -> pi_sw_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pi_sw_s1_agent_rsp_fifo_out_data;                                          // pi_sw_s1_agent_rsp_fifo:out_data -> pi_sw_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> pi_sw_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // pi_sw_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> pi_sw_s1_agent:cp_channel
	...
	wire  [103:0] po_led_s1_agent_rp_data;                                                   // po_led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] pi_key_s1_agent_rp_data;                                                   // pi_key_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] pi_sw_s1_agent_rp_data;                                                    // pi_sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [103:0] sdram_s1_rsp_width_adapter_src_data;                                       // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_008:sink_data
	...
	wire  [103:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	crypto_wallet_mm_interconnect_0_cmd_mux_002 cmd_mux_008 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	crypto_wallet_mm_interconnect_0_rsp_demux_002 rsp_demux_008 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
