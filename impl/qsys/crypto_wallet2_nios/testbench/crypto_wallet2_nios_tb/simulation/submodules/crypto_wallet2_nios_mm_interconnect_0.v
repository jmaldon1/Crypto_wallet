...
module crypto_wallet2_nios_mm_interconnect_0 (
	...
	wire  [102:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> epcs_flash_controller_epcs_control_port_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // epcs_flash_controller_epcs_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> epcs_flash_controller_epcs_control_port_agent:cp_channel
	...
	wire   [26:0] po_led_s1_agent_m0_address;                                                // po_led_s1_agent:m0_address -> po_led_s1_translator:uav_address
	...
	wire  [103:0] po_led_s1_agent_rf_source_data;                                            // po_led_s1_agent:rf_source_data -> po_led_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] po_led_s1_agent_rsp_fifo_out_data;                                         // po_led_s1_agent_rsp_fifo:out_data -> po_led_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> po_led_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // po_led_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> po_led_s1_agent:cp_channel
	...
	wire  [102:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> uart_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // uart_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> uart_s1_agent:cp_channel
	...
	wire  [102:0] epcs_flash_controller_epcs_control_port_agent_rp_data;                     // epcs_flash_controller_epcs_control_port_agent:rp_data -> router_005:sink_data
	...
	wire  [102:0] po_led_s1_agent_rp_data;                                                   // po_led_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [102:0] uart_s1_agent_rp_data;                                                     // uart_s1_agent:rp_data -> router_009:sink_data
	...
	crypto_wallet2_nios_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	crypto_wallet2_nios_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
