...
def runSim(testcase, gui, coverstore, sdf, log, vcd, wave, quit, wavefile):
    # testsim = os.path.join("..", "..", "test", "tb_" + testcase)
    # vsim tb_$testcase $gui $coverstore $sdf -name $testcase -do "$log; $vcd; $wave; run -a; $quit" -l vsim.log $wavefile
    print("vsim tb_" + testcase + " " + gui + " " + coverstore + " " + sdf + "-name " + testcase +
              " -do \"" + log + "; " + vcd + "; " + wave + "; run -a; " + quit + "\" -l vsim.log " + wavefile)
    os.system("vsim tb_" + testcase + " " + gui + " " + coverstore + " " + sdf + "-name " + testcase +
              " -do \"" + log + "; " + vcd + "; " + wave + "; run -a; " + quit + "\" -l vsim.log " + wavefile)
...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(
            argv, "hCcgvG:t:", ["help=", "compile=", "coverage=", "gui=", "vcd=", "Gatesim=", "test="])
